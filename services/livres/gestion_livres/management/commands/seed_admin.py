...
class Command(BaseCommand):
    help = "Crée ou met à jour le compte administrateur Django pour le service livres."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Compte admin livres prêt: {username}"))
